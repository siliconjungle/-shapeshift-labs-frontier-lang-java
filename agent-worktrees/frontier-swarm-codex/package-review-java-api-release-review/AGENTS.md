# @shapeshift-labs/frontier-lang-java Agent Notes
...
Use `main` as the default GitHub branch. This package should publish as `@shapeshift-labs/frontier-lang-java` and push to `git@github.com:siliconjungle/-shapeshift-labs-frontier-lang-java.git`.
